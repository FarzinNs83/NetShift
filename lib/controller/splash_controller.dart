...
class SplashScreenController extends GetxController
  ...
  List<DnsModel> newOfflineDnsList = [
    ...
    DnsModel(
        name: 'Google DNS', primaryDNS: "8.8.8.8", secondaryDNS: "8.8.4.4"),
    DnsModel(
        name: 'CloudFlare DNS', primaryDNS: "1.1.1.1", secondaryDNS: "1.0.0.1"),
    DnsModel(
        name: 'Open DNS',
  ...
  void onInit() async {
    ...
    progressController =
        Tween<double>(begin: 0, end: 0.8).animate(animationController);
  }
